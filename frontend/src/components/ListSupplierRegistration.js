...
// Shows details of all recipe...
 class ListLegalCaseType extends Component{
  constructor(props){
  super(props);
...
render(){
    return (
      ...
      <div className = "col-lg-9 mt-2 mb-2" >
        &nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-success" variant = "primary"> <a href="/SupplierRegistration" style={{textDecoration:'none',color:'white'}}>
        ...
        <tbody>
          {
            this.state.posts.map((posts,index)=>(
              <tr key={index}>
                ...
                <td>
                  {/* Edit button */}
                  <a className="btn btn-info" href={`/EditSupplierRegistration/${posts._id}`}>
...
export default ListLegalCaseType;
