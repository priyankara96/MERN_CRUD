    ...
    <div>
        <AppBar sx={{backgroundColor:"#ffff", width:"auto", ml:"auto"}} position='sticky'>
          ...
          <Toolbar>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a className="nav-link" aria-current="page" href="/ListSupplierRegistration"><div class="text-secondary">Home</div></a>
            <a className="nav-link" aria-current="page" href="/SupplierRegistration"><div class="text-secondary">Contact</div></a>
